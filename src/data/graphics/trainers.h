...
const u32 gTrainerFrontPic_Camper2[] = INCBIN_U32("graphics/trainers/front_pics/camper2.4bpp.smol");
const u16 gTrainerPalette_Camper2[] = INCBIN_U16("graphics/trainers/front_pics/camper2.gbapal");
