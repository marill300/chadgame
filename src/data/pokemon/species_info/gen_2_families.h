...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_FILTER, ABILITY_NONE, ABILITY_LEAF_GUARD },
    ...
    [SPECIES_BAYLEEF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_FILTER, ABILITY_NONE, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_NONE, ABILITY_ADAPTABILITY },
    ...
    [SPECIES_LANTURN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_SWIFT_SWIM, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_QWILFISH] =
    {
        .baseHP        = 85,
        .baseAttack    = 105,
        .baseDefense   = P_UPDATED_STATS >= GEN_7 ? 105 : 75,
        .baseSpeed     = 85,
        .baseSpAttack  = 55,
        .baseSpDefense = 55,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_IRON_BARBS, ABILITY_SWIFT_SWIM, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MAGCARGO] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 75 : 50,
        .baseAttack    = 50,
        .baseDefense   = 120,
        .baseSpeed     = 30,
    ...
    [SPECIES_CORSOLA] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 75 : 55,
        .baseAttack    = 55,
        .baseDefense   = P_UPDATED_STATS >= GEN_7 ? 105 : 85,
        .baseSpeed     = 35,
        .baseSpAttack  = 65,
        ...
        .abilities = { ABILITY_FILTER, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
