...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DAWN_STONE, SPECIES_LYCANROC_MIDDAY},
    ...
    [SPECIES_ROCKRUFF_OWN_TEMPO] =
    {
        ...
        .eggMoveLearnset = sRockruffEggMoveLearnset,
        .formSpeciesIdTable = sRockruffFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DUSK_STONE, SPECIES_LYCANROC_DUSK}),
    },
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_SALAZZLE, CONDITIONS({IF_GENDER, MON_FEMALE})},
